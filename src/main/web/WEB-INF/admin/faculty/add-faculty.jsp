...
<body>
    ...
    <form class="add-faculty-form" action="/home/faculty/add-faculty" method="post">
        <div>
            <input type="text" name="name_en" placeholder="<fmt:message key="faculty.name.en"/>"/>
            <input type="text" name="name_ua" placeholder="<fmt:message key="faculty.name.ua"/>"/>
            <input type="text" name="maxBudgetPlaces" placeholder="<fmt:message key="faculty.max.budget.places"/>"/>
            <input type="text" name="maxPlaces" placeholder="<fmt:message key="faculty.max.places"/>"/>
        </div>
        <div>
            <div>
