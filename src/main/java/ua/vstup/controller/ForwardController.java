...
@WebServlet(urlPatterns = {Constants.Urls.LOGIN_FORWARD, Constants.Urls.REGISTER_FORWARD,
        Constants.Urls.ERROR, Constants.Urls.REQUESTS_FORWARD, Constants.Urls.FACULTY_FORWARD,
        Constants.Urls.PROFILE_FORWARD, Constants.Urls.ADD_FACULTY_FORWARD,
        Constants.Urls.EDIT_FACULTY_FORWARD
})
